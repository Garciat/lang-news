...
date: 2025-08-19
language: haskell
source: "https://blog.haskell.org/ghc-9-14-1-alpha1/"
tags: [compiler]
version: ""
url: /articles/2025-08-19-haskell/
---

The GHC developers are very pleased to announce the availability of the first alpha prerelease of GHC 9.14.1. Binary distributions, source distributions, and documentation are available at [downloads.haskell.org](https://downloads.haskell.org/ghc/9.14.1-alpha1).
...
- Specialisation is now considerably more reliable in the presence of `newtype`s
...
- ... and many more
A full accounting of changes can be found in the [release notes](https://downloads.haskell.org/ghc/9.14.1-alpha1/docs/users_guide/9.14.1-notes.html). Given the many specialisation improvements and their potential for regression, we would very much appreciate testing and performance characterisation on downstream workloads.
...
As always, do give this release a try and open a [ticket](https://gitlab.haskell.org/ghc/homepage/-/issues/new) if you see anything amiss.

[‹ Google Summer of Code 2025 Wrap-up](https://blog.haskell.org/gsoc-2025/)[Cabal 3.16 release ›](https://blog.haskell.org/cabal-3-16-0-0-release/)