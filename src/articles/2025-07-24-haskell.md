...
date: 2025-07-24
language: haskell
source: "https://blog.haskell.org/cabal-3-16-0-0-release/"
tags: [release, cabal]
version: ""
url: /articles/2025-07-24-haskell/
---

[Artem Pelenitsyn](https://blog.haskell.org/authors/artem-pelenitsyn/)  July 24, 2025  [[Cabal](https://blog.haskell.org/categories/cabal/)] #[Release](https://blog.haskell.org/tags/release/) 
...
- [On our website](https://downloads.haskell.org/cabal/cabal-install-3.16.0.0/) (the same set of binaries can also be installed via the GHCup vanilla channel); these binaries are signed by "Francesco Ariis [francesco@ariis.it](mailto:francesco@ariis.it)" (fingerprint: `DAFB 4D8A F684 1435 18D5  051F A9AF 0AAA 6B87 EC51`; the key is hosted on keyserver.ubuntu.com).
...
Please report any issues you notice with the 3.16.0.0 release on our GitHub: [ht
