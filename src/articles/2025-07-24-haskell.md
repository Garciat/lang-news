...
Please report any issues you notice with the 3.16.0.0 release on our GitHub: [https://github.com/haskell/cabal/issues](https://github.com/haskell/cabal/issues)

— Cabal release team (Artem, Brandon, Francesco, Mikołaj)

[‹ GHC 9.14.1-alpha1 is now available](https://blog.haskell.org/ghc-9-14-1-alph
